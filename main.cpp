...
//    Polynomial::printPoly(reminders[reminders.size() - 1]);
    ...
    Term t1 = Term(boost::rational<int>(1,1), {0,0,0});
    Term t2 = Term(boost::rational<int>(2,1), {10,0,0});
    Term t3 = Term(boost::rational<int>(3,1), {2,0,0});
    Term t4 = Term(boost::rational<int>(4,1), {0,5,0});
    Term t5 = Term(boost::rational<int>(5,1), {1,1,4});
